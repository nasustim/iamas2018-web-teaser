...
var _ScrollMagic = require('scrollmagic/scrollmagic/uncompressed/ScrollMagic');

var _ScrollMagic2 = _interopRequireDefault(_ScrollMagic);

var _animation = require('scrollmagic/scrollmagic/uncompressed/plugins/animation.gsap');
...
module.exports = function (ele, _delay) {
  var $target = (0, _jquery2.default)(ele);
  var duration = 1.2;
  ...
  $target.each(function () {
    (0, _jquery2.default)(this).addClass('is-show-animation');
    var tween = _gsap.TweenMax.to((0, _jquery2.default)(this), duration, endStyle);
    var scene = new _ScrollMagic2.default.Scene({ triggerHook: 0.7, triggerElement: this, reverse: false }).setTween(tween).addTo(controller);
  });
};

},{"gsap":3,"jquery":4,"scrollmagic/scrollmagic/uncompressed/ScrollMagic":5,"scrollmagic/scrollmagic/uncompressed/plugins/animation.gsap":6}],2:[function(require,module,exports){
'use strict';
...
var _fadeInElements = require('./_fadeInElements');
